...
#
# Filename    : xxv_ethernet_0_gt_3.sh
...
#
# Generated by Vivado on Wed Apr 14 11:38:17 +0800 2021
# SW Build 3064766 on Wed Nov 18 09:12:45 MST 2020
#
# Copyright 1986-2020 Xilinx, Inc. All Rights Reserved. 
#
# usage: xxv_ethernet_0_gt_3.sh [-help]
# usage: xxv_ethernet_0_gt_3.sh [-lib_map_path]
# usage: xxv_ethernet_0_gt_3.sh [-noclean_files]
# usage: xxv_ethernet_0_gt_3.sh [-reset_run]
#
...
# executing this script. Please type 'xxv_ethernet_0_gt_3.sh -help' for more information.
#
...
# Script info
echo -e "xxv_ethernet_0_gt_3.sh - Script generated by export_simulation (Vivado v2020.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"D:/Vivado_2020.2/Vivado/2020.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../xxv_ethernet_0_ex.gen/sources_1/ip/xxv_ethernet_0_gt_3/sim/gtwizard_ultrascale_v1_7_gthe3_channel.v" \
    "$ref_dir/../../../../xxv_ethernet_0_ex.gen/sources_1/ip/xxv_ethernet_0_gt_3/sim/xxv_ethernet_0_gt_3_gthe3_channel_wrapper.v" \
    "$ref_dir/../../../../xxv_ethernet_0_ex.gen/sources_1/ip/xxv_ethernet_0_gt_3/sim/xxv_ethernet_0_gt_3_gtwizard_gthe3.v" \
    "$ref_dir/../../../../xxv_ethernet_0_ex.gen/sources_1/ip/xxv_ethernet_0_gt_3/sim/xxv_ethernet_0_gt_3_gtwizard_top.v" \
    "$ref_dir/../../../../xxv_ethernet_0_ex.gen/sources_1/ip/xxv_ethernet_0_gt_3/sim/xxv_ethernet_0_gt_3.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.xxv_ethernet_0_gt_3 xil_defaultlib.glbl -o xxv_ethernet_0_gt_3_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./xxv_ethernet_0_gt_3_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./xxv_ethernet_0_gt_3.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key xxv_ethernet_0_gt_3_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc xxv_ethernet_0_gt_3_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./xxv_ethernet_0_gt_3.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: xxv_ethernet_0_gt_3.sh [-help]\n\
Usage: xxv_ethernet_0_gt_3.sh [-lib_map_path]\n\
Usage: xxv_ethernet_0_gt_3.sh [-reset_run]\n\
Usage: xxv_ethernet_0_gt_3.sh [-noclean_files]\n\n\
