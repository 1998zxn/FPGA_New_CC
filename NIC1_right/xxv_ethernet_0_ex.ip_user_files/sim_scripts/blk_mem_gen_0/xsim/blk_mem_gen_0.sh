...
simulate()
{
  xsim blk_mem_gen_0 -key {Behavioral:sim_3:Functional:blk_mem_gen_0} -tclbatch cmd.tcl -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/Vivado_2020.2/Vivado/2020.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
