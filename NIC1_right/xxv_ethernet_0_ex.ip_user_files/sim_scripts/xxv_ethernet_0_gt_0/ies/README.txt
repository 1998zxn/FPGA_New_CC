...
#
# Generated by export_simulation on Wed Apr 14 11:38:29 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './xxv_ethernet_0_gt_0.sh' script.

./xxv_ethernet_0_gt_0.sh -reset_run
...
./xxv_ethernet_0_gt_0.sh -noclean_files

For more information on the script, please type './xxv_ethernet_0_gt_0.sh -help'.
